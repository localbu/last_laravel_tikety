<x-frontend.layout>
    ...
    <section id="eventDescription" class="container max-w-screen-xl pt-[70px] relative pb-[156px]">
        <div class="flex flex-wrap items-start justify-between gap-y-[30px]">
            ...
            <form class="bg-primary p-5 rounded-2xl flex flex-col gap-5 max-w-[380px] w-full md:-mt-[120px] z-10 relative" action="{{ route('checkout', $event->slug) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
